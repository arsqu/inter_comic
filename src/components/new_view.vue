  ...
  <div class="viewLayout">
    ...
    <div class="translateBox">
      <div :class="['chapterBox',!translate?'offsetL':'']">
        <ul class>
          <li v-for="(item,idx) in chapterList" :key="idx" @click="viewDetl(item,idx)">
            <span>{{$t("column.chapter")+' '+item.order_no}}</span>
            <span v-if="item.is_free" class="lock">{{price}}{{$t('common.priceUnit')}}</span>
          </li>
        </ul>
      </div>
      <div :class="['top_bar',translate?'offset':'']">
        <div class="top_title">
        ...
        <div class="top_tools">
          <router-link :to="{name:'main'}">
            <img src="/static/img/icon_new/home_view.png" alt="home" />
          </router-link>
        </div>
      </div>
    ...
    <div class="bottom_bar">
      <div class="top_tools">
        <a href="javascript:;" @click="toDetl">
          <img src="/static/img/icon_new/list.png" alt="home" />
        </a>
        <a href="javascript:;" @click="viewPrev">
          <img src="/static/img/icon_new/prev.png" alt="prev" />
        </a>
        <a href="javascript:;" @click="viewNext">
          <img src="/static/img/icon_new/next.png" alt="next" />
        </a>
      </div>
    </div>
  </div>
